...
In the front-end course, you used a JSON data file to store data (and data changes!) that will persist between app sessions. In this book you will learn to use a number of technologies to do this instead:
...
|-|
|:elephant: Creating a PostgreSQL database using pgAdmin|
|:house: Roommates|
